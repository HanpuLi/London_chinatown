...
2. 输入链接内容：
   ```
   file:///Users/caitlye/Downloads/london_chinatown_final_report/interactive_map.html
   ```
...
#### 直接访问链接：
```
https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=file:///Users/caitlye/Downloads/london_chinatown_final_report/interactive_map.html
```
...
# 添加数据
qr.add_data('file:///Users/caitlye/Downloads/london_chinatown_final_report/interactive_map.html')
qr.make(fit=True)
